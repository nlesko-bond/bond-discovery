      ...
      <div className="max-w-md w-full mx-4">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
          ...
          <div className="text-center mb-8">
            <div className="w-16 h-16 bg-toca-purple/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
              <Shield className="w-8 h-8 text-toca-purple" />
            </div>
            <h1 className="text-2xl font-bold text-gray-900">Bond Discovery</h1>
            ...
            <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-red-600 mt-1">
                  {error === 'AccessDenied' 
                    ? 'Only @bondsports.co email addresses are allowed.'
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            Only @bondsports.co email addresses are authorized.
          </p>
        </div>
        
        {/* Footer */}
        <p className="text-center text-xs text-gray-400 mt-6">
          Bond Sports Discovery Platform
        </p>
      </div>
    </div>
  );
